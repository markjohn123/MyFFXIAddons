...
function init_gear_sets()
    -- include(''..player.name..'/gear/WHM_Gearsets.lua')
    ...
    -- Standard WHM Gear used in multiple places
        ...
        gsWHM.Body = {name="Orison Bliaud +1"}
        gsWHM.legs = {name="Assiduity Pants"}
        gsWHM.feet = {name="Regal Pumps"}
        gsWHM.Ring1 = {name="Hale Ring"}
        ...
        gsWHM.CP.feet = {name="Medium's Sabots"}
    ...
    sets.midcast.CureSolace = {main=gsWHM.CP.main,sub=gsWHM.Genbu,ammo="Incantor Stone",
        head="Gendewitha Caubeen",neck="Orison Locket",ear1="Lifestorm Earring",ear2=gsWHM.CP.ear1,
        body=gsWHM.Body,hands="Theophany Mitts",ring1="Prolix Ring",ring2="Sirona's Ring",
        back=gsWHM.CP.back,waist=gear.ElementalObi,legs="Orison Pantaloons +2",feet=gsWHM.CP.feet}
    ...
    sets.midcast.Cursna = {main="Beneficus",sub=gsWHM.Genbu,
        ...
        body=gsWHM.Body,hands="Fanatic Gloves",ring1="Ephedra Ring",ring2="Sirona's Ring",
        back=gsWHM.CP.back,waist="Goading Belt",legs="Theophany Pantaloons",feet="Gendewitha Galoshes"}
    ...
    sets.midcast['Enhancing Magic'] = {main="Beneficus",sub=gsWHM.Genbu,
        ...
        back=gsWHM.CP.back,waist="Olympus Sash",legs="Piety Pantaloons",feet="Orison Duckbills +2"}
    ...
    sets.midcast['Dark Magic'] = {main="Bolelabunga", sub=gsWHM.Genbu,
        head=gsWHM.FC.Head,neck="Imbodia necklace",ear1="Psystorm Earring",ear2="Lifestorm Earring",
        body=gsWHM.FC.body,hands="Fanatic Gloves",ring1=gsWHM.Int.Ring1,ring2="Sangoma Ring",
    ...
    sets.midcast.MndEnfeebles = {main="Lehbrailg +2", sub="Mephitis Grip",
        head=gsWHM.FC.Head,neck="Imbodia necklace",ear1="Psystorm Earring",ear2="Lifestorm Earring",
        body=gsWHM.Enf.body,hands="Fanatic Gloves",ring1=gsWHM.Enf.Ring1,ring2="Sangoma Ring",
        back="Refraction Cape",waist="Rumination Sash",legs="Bokwus Slops",feet=gsWHM.CP.feet}

    sets.midcast.IntEnfeebles = {main="Lehbrailg +2", sub="Mephitis Grip",
        head=gsWHM.FC.Head,neck="Imbodia necklace",ear1="Psystorm Earring",ear2="Lifestorm Earring",
        body=gsWHM.Enf.body,hands="Fanatic Gloves",ring1=gsWHM.Int.Ring1,ring2="Sangoma Ring",
        back="Refraction Cape",waist="Rumination Sash",legs="Bokwus Slops",feet=gsWHM.CP.feet}
    ...
    sets.idle = {main=gsWHM.CP.main, sub=gsWHM.Genbu,ammo="Incantor Stone",
        head=gsWHM.FC.Head,neck="Wiglen Gorget",ear1="Bloodgem Earring",ear2="Loquacious Earring",
        body="Gendewitha Bliaut",hands="Fanatic Gloves",ring1="Sheltered Ring",ring2="Paguroidea Ring",
    ...
    sets.idle.PDT = {main="Bolelabunga", sub=gsWHM.Genbu,ammo="Incantor Stone",
        ...
        body=gsWHM.Enf.body,hands="Fanatic Gloves",ring1="Defending Ring",ring2=gear.DarkRing.physical,
        back=gsWHM.back,waist="Witful Belt",legs=gsWHM.legs,feet="Hippomenes Socks"}
    ...
    sets.idle.Town = {main="Bolelabunga", sub=gsWHM.Genbu,ammo="Incantor Stone",
        ...
        body="Councilor's Garb",hands="Fanatic Gloves",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back=gsWHM.back,waist="Witful Belt",legs=gsWHM.legs,feet="Hippomenes Socks"}
