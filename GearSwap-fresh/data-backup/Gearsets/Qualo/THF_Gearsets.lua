...
sets.idle.PDT = {
    ...
    hands=Aug.Rawhide.hands,
    legs=gsBST.legs,
    feet=Aug.Rawhide.feet,
...
sets.TP = { ranged="Raider's Bmrng.",
            ...
            body="Pillager's Vest +1", Aug.Rawhide.hands, lring="Rajas Ring", rring="Epona's Ring",
            back="Atheling Mantle", waist="Patentia Sash", legs="Taeon Tights", feet=Aug.Rawhide.feet}

-- Accuracy TP Set
sets.TP.Acc = {	ammo="Ginsen",
			head="Skulker's Bonnet", neck="Iqabi Necklace", lear="Brutal Earring", rear="Suppanomimi",
            body="Pillager's Vest +1", Aug.Rawhide.hands, lring="Rajas Ring", rring="Ramuh Ring +1",
            back="Atheling Mantle", waist="Patentia Sash", legs="Taeon Tights", feet=Aug.Rawhide.feet}
...
sets.TP.Buffed = {	ammo="Ginsen",
			head="Skulker's Bonnet", neck="Asperity Necklace", lear="Brutal Earring", rear="Suppanomimi",
            body="Pillager's Vest +1", Aug.Rawhide.hands, lring="Rajas Ring", rring="Epona's Ring",
            back="Atheling Mantle", waist="Windbuffet Belt", legs="Taeon Tights", feet=Aug.Rawhide.feet}
...
sets.TP.Hybrid = set_combine(sets.idle.PDT,{
            ...
            back="Fravashi Mantle", waist="Twilight Belt", legs="Taeon Tights", feet=Aug.Rawhide.feet})
...
sets.precast.JA["Sneak Attack"] = {
                ...
                back="Atheling Mantle", waist="Windbuffet Belt", legs="Taeon Tights"}
-- Trick Attack
sets.precast.JA["Trick Attack"] = {
				head="Pill. Bonnet +1", neck="Asperity Necklace", lear="Brutal Earring", rear="Kuwunga Earring",
                body="Pillager's Vest +1", Aug.Rawhide.hands, lring="Garuda Ring +1", rring="Garuda Ring +1",
                back="Vespid Mantle", waist="Windbuffet Belt", legs="Taeon Tights"}

-- Weaponskills
sets.precast.WS = {
				head="Pill. Bonnet +1", neck="Asperity Necklace", lear="Brutal Earring", rear="Moonshade Earring",
                body="Pillager's Vest +1", Aug.Rawhide.hands, lring="Ifrit Ring +1", rring="Ifrit Ring +1",
                back="Vespid Mantle", waist="Wanion Belt", legs="Taeon Tights"}
...
sets.precast.WS.Acc = {
                ...
                body="Pillager's Vest +1", Aug.Rawhide.hands, lring="Rajas Ring", rring="Ramub Ring +1",
                back="Vespid Mantle", waist="Wanion Belt", legs="Taeon Tights"}
...
sets.precast.WS["Mercy Stroke"] = {
                ...
                body="Pillager's Vest +1", Aug.Rawhide.hands, lring="Ifrit Ring +1", rring="Ifrit Ring +1",
                back="Vespid Mantle", waist="Prosilio Belt", legs="Taeon Tights"}
...
sets.precast.WS.SA["Rudra's Storm"] = {
                ...
                back="Vespid Mantle", waist="Wanion Belt", legs="Pillager's Culottes"}
...
sets.precast.WS.Acc["Rudra's Storm"] = {
				head="Pill. Bonnet +1", neck="Fotia Gorget", lear="Brutal Earring", rear="Moonshade Earring",
                body="Pillager's Vest +1", hands="Pillager's Armlets", lring="Rajas Ring", rring="Ramuh Ring +1",
                back="Vespid Mantle", waist="Wanion Belt", legs="Pillager's Culottes", feet=Aug.Rawhide.feet}
...
sets.precast.WS["Exenterator"] = {
                ...
                body="Pillager's Vest +1", Aug.Rawhide.hands, lring="Garuda Ring +1", rring="Epona's Ring",
                back="Vespid Mantle", waist="Prosilio Belt", legs="Taeon Tights"}
...
sets.precast.WS["Evisceration"] = {
				head="Pill. Bonnet +1", neck="Love Torque", lear="Brutal Earring", rear="Moonshade Earring",
                body="Pillager's Vest +1", Aug.Rawhide.hands, lring="Rajas Ring", rring="Epona's Ring",
                back="Atheling Mantle", waist="Wanion Belt", legs="Pillager's Culottes"}

sets.precast.WS.Acc["Evisceration"] = {
				head="Skulker's Bonnet", neck="Love Torque", lear="Brutal Earring", rear="Moonshade Earring",
                body="Pillager's Vest +1", Aug.Rawhide.hands, lring="Ramuh Ring +1", rring="Epona's Ring",
                back="Atheling Mantle", waist="Wanion Belt", legs="Pillager's Culottes"}
