...
if player.name == 'Qualo' then
    ...
    -- no Kumbha yet but laving here for hopeful future
    ...
    Pet_PDT_rear = "Handler's Earring"

    Pet_MDT_body = {name="Despair Mail", augments={'Accuracy+10','Pet: VIT+7','Pet: Damage taken -3%',}}
    Pet_MDT_hands = "Ankusa Gloves"
    Pet_MDT_legs = {name="Acro Breeches", augments={'Pet: DEF+25','Pet: "Regen"+3','Pet: Damage taken -4%',}}
    Pet_MDT_feet = "Ankusa Gaiters"
    ...
    Ready_Atk_legs = "Totemic Trousers"
    Ready_Atk_feet = {name="Taeon Boots", augments={'Pet: Attack+10 Pet: Rng.Atk.+10','Pet: "Subtle Blow"+4','STR+1 AGI+1',}}

    Ready_Atk_back = {name="Pastoralist's Mantle", augments={'STR+2 DEX+2','Accuracy+1','Pet: Damage taken -3%',}}
    ...
    Ready_Acc_feet = {name="Taeon Boots", augments={'Pet: Accuracy+23 Pet: Rng. Acc.+23',}}
    ...
    DW_body = {name="Despair Mail", augments={'Accuracy+10','Pet: VIT+7','Pet: Damage taken -3%',}}
    DW_hands = {name="Xaddi Gauntlets", augments={'Attack+7','Accuracy+6',}}
    DW_legs = {name="Taeon Tights", augments={'Pet: Attack+5 Pet: Rng.Atk.+5','Pet: Breath+3','STR+5 AGI+5',}}
    DW_feet = {name="Taeon Boots", augments={'Pet: Attack+10 Pet: Rng.Atk.+10','Pet: "Subtle Blow"+4','STR+1 AGI+1',}}
    ...
    sets.CurePetOnly = {main=Cure_Potency_axe}

    sets.midcast.Stoneskin = {back=Pet_PDT_back}
    ...
    -- DEFENSE SETS
    sets.defense.PDT = {
        head="Jumalik Helm",neck="Diemer Gorget",ear2="Genmei Earring",
    ...
    sets.defense.HybridPDT = {ammo="Sihirik",
        head="Jumalik Helm",neck="Twilight Torque",ear1="Handler's Earring",ear2="Handler's Earring +1",
    ...
    sets.defense.MDT = set_combine(sets.defense.PDT, {ammo="Sihirik",
        head="Jumalik Helm",neck="Twilight Torque",ear1="Sanare Earring",ear2="Etiolation Earring",
        body="Jumalik Mail",
