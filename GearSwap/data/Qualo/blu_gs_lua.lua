function get_sets()
	...
	sets.TP.Standard = {ammo="Ginsen",
						...
						body="Thaumas coat",hands="Qaaxo mitaines",ring1="Epona's ring",ring2="Rajas ring",
	...
	sets.BlueMagic.INT = {ammo="Erlene's notebook",
						  head="Hagondes hat",neck="Eddy necklace",ear1="Hecate's earring",ear2="Friomisi earring",
						  body="Hagondes Coat +1",hands="Mv. bazubands +2",ring1="Archon ring",ring2="Acumen ring",
						  back="Cornflower cape",waist="Penitent's rope",legs="Hagondes Pants +1",feet="Hagondes sabots"}
