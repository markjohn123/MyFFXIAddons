...
function init_gear_sets()
    ...
    sets.Enmity = {
        body="Emet Harness", --9
        -- hands="Horos Bangles +1", --9  make these
    ...
    sets.precast.Waltz = {
        head="Maxixi Tiara +1",
        body="Maxixi Casaque +1", --19(8)                                --
        hands="Horos Bangles +1",
        legs="Dashing Subligar", --10
        feet="Maxixi Toeshoes +1", --14
    ...
    sets.precast.Jig = {legs="Horos Tights +1", feet="Maxixi Toeshoes +1"}
    ...
    sets.engaged.LowAcc = set_combine(sets.eng5aged, {
        head="Dampening Tam",
        })
