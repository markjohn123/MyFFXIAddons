...
--includes
	...
	-- Get THF Gearsets
	include('gear/THF_Gearsets.lua')
	windower.add_to_chat(121,'Loaded THF.lua')
...
function user_setup()
    windower.add_to_chat(121,'setting macros')
...
function slot_lock()
    ...
    elseif player.equipment.head=='Reraise Hairpin' then
        disable('head')
        windower.add_to_chat(8,'Reraise Hairpin equiped on head')
    else
        enable('left_ear','right_ear','head')
    end
    if player.equipment.waist == 'Chaac Belt' then
        disable('waist')
        windower.add_to_chat(8,'Chaac Belt equiped on waist')
    else
        enable('waist')
    end
    if player.equipment.back == Aug.CPCape then
        disable('back')
        windower.add_to_chat(8,'CP Mantle equiped on back')
    else
        enable('back')
    end
    ...
    if player.equipment.neck == "Adoulin's Refuge +1" then
        disable('neck')
        windower.add_to_chat(8,'Reive neck loaded')
    else
        enable('neck')
    end
