...
-- Standard THF Gear
        gsTHF = {}
        gsTHF.main = "Sandung"
        gsTHF.sub = "Jugo Kukri +1"
        gsTHF.range = "Raider's Bmrng."
        gsTHF.ammo = {}
        gsTHF.head = "Skormoth Mask"
        gsTHF.body = "Adhemar Jacket"
        gsTHF.hands = "Plun. Armlets +1"
        gsTHF.legs = "Herculean Trousers"
        gsTHF.feet = "Herculean Boots"
        gsTHF.neck="Asperity Necklace"
        gsTHF.waist="Chaac Belt"
        gsTHF.left_ear="Bladeborn Earring"
        gsTHF.right_ear="Steelflash Earring"
        gsTHF.left_ring="Rajas Ring"
        gsTHF.right_ring="K'ayres Ring"
        gsTHF.back="Ground. Mantle +1"
...
-- Augmented Gear
	...
	Aug.Rawhide.hands = {name="Rawhide Gloves", augments={'HP+19','Accuracy+4','Evasion+9',}}
        ...
        Aug.Lustratio = {}
        Aug.Lustratio.hands = {name="Lustratio Mittens"}
