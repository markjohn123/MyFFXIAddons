...
function set_style(sheet)
	...
	add_to_chat (21, 'Your Lockstyle Looks Hot - Herc FTW')
	add_to_chat (121, 'You are on BLU btw')
	-- sneak in command to load knockblock
        -- send_command('@input //lua load knockblock')
end
...
function get_sets()
	...
	HerculeanFeet = {}
	HerculeanFeet.QA ="Herculean Boots"
	HerculeanFeet.TA = "Herculean Boots"
	HerculeanFeet.DT = "Herculean Boots"
	HerculeanFeet.Idle = "Herculean Boots"
	HerculeanFeet.CritDmg = "Herculean Boots"
	HerculeanFeet.WSD = "Herculean Boots"
	HerculeanFeet.DW = "Herculean Boots"

	Rosmerta = {}
	Rosmerta.Crit ="Rosmerta's Cape"
	Rosmerta.WSD ="Rosmerta's Cape"
	Rosmerta.STP ="Rosmerta's Cape"
	Rosmerta.DW ="Rosmerta's Cape"
	Rosmerta.Nuke ="Rosmerta's Cape"
	Rosmerta.Cure = "Rosmerta's Cape"
	...
	sets.Idle.Standard = {
                ...
                sub="Vampirism",  --  0
                ammo="Falcon Eye",   -- 13
                head="Aya. Zucchetto", -- 14 (dex) 26 (acc) total 40
                body="Ayanmo Corazza", -- 18 (dex) 28 (acc) total 46
                 -- body="Adhemar Jacket", -- 16 (dex) 25 (acc) total 41
                hands="Rawhide gloves", -- 20 (dex) 35 (acc) total 55
                -- hands="Aya. Manopolas", -- 21 (dex) 25 (acc) total 46
                legs="Carmine Cuisses", -- 25
                feet="Herculean Boots",  -- 12 (dex) 29 (acc) total 41
                neck="Clotharius Torque",  -- 8
                waist="Metalsinger Belt",  -- 5
                left_ear="Zennaroi Earring",  -- 12
                right_ear="Steelflash Earring",  -- 8
                left_ring="Apate Ring",
                right_ring="Rajas Ring",
                back="Ground. Mantle +1", -- 21
                -- primary acc 1030 on April 4
	}
	...
	sets.TP.DualWield = { -- this set needs converted to dw, copied from acc
                main="Colada",    -- 20 (acc)
                sub="Vampirism",  --  0
                ammo="Falcon Eye",   -- 13
                head="Aya. Zucchetto", -- 14 (dex) 26 (acc) total 40
	...
	sets.TP.CappedHaste = {
                ...
                sub="Vampirism",
                ammo="Ginsen",
                head="Adhemar Bonnet", -- 8
                body="Adhemar Jacket",  -- 4
                hands="Rawhide Gloves",  -- 5
                -- legs="Ayanmo Cosciales",  -- 9
		legs = "Samnuha Tights",  -- 6
                feet="Herculean Boots",  -- 4
