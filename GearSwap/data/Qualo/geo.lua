...
-------------------------------------------------------
 ...
 -- Use an in game macro "/con gs c geo_mode" to set geo mode to the value of the
 -- geo_mode variable
 -- Use an in game macro "/con gs c entrust_acc" to set indi mode to Precision
...
function get_sets()
 ...
 --------------------------------------
    ...
    sets.midcast.FastRecast = {
        ...
        back="Lifestream Cape",waist="Channeler's Stone",legs="Geomancy Pants",feet="Merlinic Crackows"}
    ...
    sets.midcast['Enhancing Magic'] = {
        head="Befouled Crown", neck="Melic Torque", ear1="Andoaa Earring", ear2="Loquacious Earring",
        body="Telchine Chasuble",hands="Amalric gages", lring="Metamor. Ring +1", rring="Perception ring",                     5
    ...
    sets.midcast['Enfeebling Magic'] = {main="Marin staff", sub="Achaq Grip", range="Aureole",
	head="Befouled Crown", neck="Henic torque", rear="Barkarole Earring", lear="Psystorm Earring",
        body="Vanya Robe", hands="Azimuth Gloves", lring="Irrwisch Ring", rring="Perception ring",
        back="Lifestream Cape", waist="Ovate Rope", legs="Psycloth Lappas", feet="Merlinic Crackows"}

      sets.midcast['Elemental Magic'] = {main="Marin staff", sub="Achaq Grip", ammo="Ghastly Tathlum",
    ...
    sets.midcast['Dark Magic'] = {main="Marin staff", sub="Achaq Grip", range="Dunna",
    ...
    sets.magic_burst = {main="Marin staff", sub="Achaq Grip", ammo="Ghastly Tathlum",
    ...
    sets.idle.Town = {main="Marin staff", sub="Niobid Strap", range="Dunna",
    ...
    -- Normal melee group
    sets.engaged = {main="Marin staff", sub="Volos Strap", range="Dunna",
        head="Vanya Hood",neck="Loricate Torque +1",ear1="Handler's Earring +1", ear2="Handler's Earring",
        body="Vanya Robe",hands="Geomancy Mitaines +1", lring="Paguroidea Ring", rring="Renaye Ring",
        back="Lifestream Cape",waist="Slipor sash",legs="Assiduity Pants +1",feet="Geomancy Sandals +1"}
...
function self_command(str)
    -- Use an in game macro "/con gs c auto_action" to toggle bot Off and On
							--macro: "/con send Qualo gs c auto_action"
    if str == 'auto_action' then
		...
		windower.send_command('input /tell Qualo Auto_action: '..auto_action)
	...
	elseif str == 'geo_mode' then
		...
		windower.send_command('input /tell Qualo Geo_mode: '..geo_mode)
